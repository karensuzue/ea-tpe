...
class TPEC:
    ...
    def run(self, X_train, y_train):
        ...
        self.ea.set_population(self.population) # EA module's population should point to self.population
        ...
        for gen in range(generations):
            ...
            self.logger.log_generation(gen, self.config.pop_size * (gen + 1), self.population, "EA+TPE")
            ...
            for p in parents:
                ...
                candidates = [copy.deepcopy(p) for _ in range(self.config.num_candidates)]
                ...
                best_org, best_ei_scores, se_count = self.tpe.suggest(candidates, num_top_cand=1) 
                ...
                self.population += best_org # a bit sloppy, but works
        ...
        self.logger.log_generation(generations, self.config.pop_size * (generations + 1), self.population, "EA+TPE")
